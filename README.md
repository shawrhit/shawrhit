...
![Language](https://img.shields.io/badge/C++-86%25-00599C?style=flat-square&logo=cplusplus)

A minimal, asynchronous Arduino wrapper around the native ESP-IDF `esp-mqtt` component for connecting ESP32 boards to **AWS IoT Core** over mutual TLS — no SPIFFS mounting, no blocking your `loop()`.

- 🔐 True mTLS — pass certificates as strings directly
- ⚡ Async message callbacks with a built-in publish queue
